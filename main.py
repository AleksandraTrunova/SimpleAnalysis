...
# ------------ Dataframe
df_numbers = pd.DataFrame({"Числа": random_nums_series})
df_numbers["По возрастанию"] = random_nums_series.sort_values(ascending=True).values
df_numbers["По убыванию"] = random_nums_series.sort_values(ascending=False).values

# --------------- Линейный график сортированных данных
plt.plot(df_numbers["По возрастанию"], label="По возрастанию", color="green")
plt.plot(df_numbers["По убыванию"], label="По убыванию", color="red")
